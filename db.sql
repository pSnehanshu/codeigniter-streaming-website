...
DROP TABLE IF EXISTS `object_heirarchy`;
...
CREATE TABLE `objects` (
  ...
  `type` enum('video','show','season','category') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'video',
  `is_premium` tinyint(1) NOT NULL DEFAULT '0',
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `published_on` timestamp NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT COMMENT='An object is either a video, show, season or category';
...
CREATE TABLE `pages` (
  ...
  `snippet` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'https://www.gravatar.com/avatar/no-avatar-set?d=mp',
...
CREATE TABLE `video_info` (
  ...
  `link` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'video/mp4',
